...
public class StaticAnimatedExplosion2 extends StaticEntity {
	
//	Animation
	private Animation anim;
	
	public StaticAnimatedExplosion2(Handler handler, float x, float y){
...
//		size of bounding box inside player tile.
		bounds.width = 0;
		bounds.height = 0;
		anim = new Animation(100, Assets.alt_explosion1_ani);
