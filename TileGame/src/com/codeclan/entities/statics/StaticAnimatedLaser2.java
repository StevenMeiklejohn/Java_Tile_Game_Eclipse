...
public class StaticAnimatedLaser2 extends StaticEntity {
	
//	Animation
	private Animation anim;
	
	public StaticAnimatedLaser2(Handler handler, float x, float y){
		super(handler, x, y, Tile.TILE_WIDTH * 10, Tile.TILE_HEIGHT);
// 		setup bounding box.	
...
//		size of bounding box inside player tile.
		bounds.width = 0;
		bounds.height = 0;
		anim = new Animation(100, Assets.laser2_ani);
