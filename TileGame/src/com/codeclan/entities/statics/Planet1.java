...
public class Planet1 extends StaticEntity {
	
	public Planet1(Handler handler, float x, float y){
...
//		bounds.y = (int) (height / 1,5f);
	...
	public void render(Graphics g) {
		g.drawImage(Assets.planet1, (int) (x - handler.getGameCamera().getxOffset()), 
